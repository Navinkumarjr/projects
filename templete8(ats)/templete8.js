...
invokebtn.addEventListener('click', mediaqueryQ)
//getting name
...
// window.addEventListener('resize', checkmediaQ)
// window.addEventListener('resize', checkmediaQ)